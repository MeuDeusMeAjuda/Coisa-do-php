/*
  # Atualização do banco de dados - Versão 2.0
  ...
  3. Segurança
    ...
    - Controle de acesso para compartilhamento
*/
...
-- Atualizar fotos existentes para o álbum padrão
UPDATE photos p
...
-- Atualizar cover_photo_id dos álbuns
UPDATE albums a
SET cover_photo_id = (
